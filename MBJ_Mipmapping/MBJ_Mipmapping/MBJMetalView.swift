...
class MBJMetalView : UIView
{
    ...
    override var frame: CGRect
        ...
        {
            //---------------------------------------------------------
            // During the first layout pass, we will not be in
            // a view hierarchy, so we guess our scale
            //---------------------------------------------------------
            ...
            //---------------------------------------------------------
            // Since drawable size is in pixels, we need to
            // multiply by the scale to move from points to pixels
            //---------------------------------------------------------
