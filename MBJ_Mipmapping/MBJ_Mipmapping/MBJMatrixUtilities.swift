...
//------------------------------------------------------------------------
func matrix_translation(t:float4) -> float4x4
{
...
{
    let X = float4( s.x, 0.0, 0.0, 0.0 )
    let Y = float4( 0.0, s.y, 0.0, 0.0 )
    let Z = float4( 0.0, 0.0, s.z, 0.0 )
...
{
    let X = float4( s, 0.0, 0.0, 0.0 )
    let Y = float4( 0.0, s, 0.0, 0.0 )
    let Z = float4( 0.0, 0.0, s, 0.0 )
    let W = float4( 0.0, 0.0, 0.0, 1.0 )
...
//------------------------------------------------------------------------
func matrix_upper_left3x3(mat4x4:float4x4) -> float3x3
{
